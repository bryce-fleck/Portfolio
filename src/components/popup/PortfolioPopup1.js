...
const PortfolioPopup1 = ({des}) => {
  const { portfolio_modal_show1, portfolio_modal1 } = useContext(DoraContext);
  useEffect(() => {
    console.log('portfolio_modal_show1-----', portfolio_modal1)
  }, [portfolio_modal1])
  return (
    <Modal close={portfolio_modal_show1}>
...
export default PortfolioPopup1;
